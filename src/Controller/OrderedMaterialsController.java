...
public class OrderedMaterialsController implements Initializable{
    ...
    @FXML
    private Button EditCustomer,UpdateProjectDetails,ProjectDetails,GenerateByAI,orderWood,NewProject,Stock,CurrentProjects,OrderedMaterials,OrdersCatalog,Inbox,BackButton;
